...
func (r ResponsesWireResponse) ToMap() map[string]any {
	...
	if r.Usage != nil {
		...
		if r.Usage.InputTokensDetails.CachedTokens > 0 || r.Usage.InputTokensDetails.CacheWriteTokens > 0 {
			details := map[string]any{
				"cached_tokens": r.Usage.InputTokensDetails.CachedTokens,
			}
			if r.Usage.InputTokensDetails.CacheWriteTokens > 0 {
				details["cache_write_tokens"] = r.Usage.InputTokensDetails.CacheWriteTokens
			}
