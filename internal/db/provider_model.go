...
// the shared tingly.db. Short-lived embedders (tests, harness environments)
// must Close, or each instance leaks a SQLite handle for the process
// lifetime; stores borrowed from StoreManager are closed by it instead.
...
// already-open connection, shared by NewModelStore and
// StoreManager.initModelStore.
