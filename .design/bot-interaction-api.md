...
### 3.2 URL shape — control-plane route family, two endpoints
...
### 3.4 Auth wiring — reuse the `apiV1` group
...
### 3.5 What about `/tingly/:scenario/notify` itself?
...
- `bot_api_test.go`: notify delivers via a fake channel; interact returns 202 +
